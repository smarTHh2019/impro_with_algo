...
def listen_to_phrase_request_from_sonic_pi(tag:str="/impro/phrase", compose_func=dummy_compose_function, port:int=4545) -> str:
    ...
    dispatcher_var.map(tag, dummy_compose_function, "TEST")
...
if __name__ == '__main__':
    ...
    listen_to_phrase_request_from_sonic_pi(tag="/impro/phrase", compose_func=dummy_compose_function, port=4545)
